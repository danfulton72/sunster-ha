...
async def async_setup_entry(hass, entry, async_add_entities):
    async_add_entities([
        ...
        SunsterSettingSwitch(entry.runtime_data, "Auto Start/Stop", "auto_start_stop", "supports_auto_start_stop", "i_stop"),
        SunsterSettingSwitch(entry.runtime_data, "Controller Wi-Fi", "wifi_enabled", "supports_wifi", "wifi"),
    ])
...
class SunsterSettingSwitch(CoordinatorEntity, SwitchEntity):
    ...
    def __init__(self, coordinator, name, key, capability, setting_key):
        super().__init__(coordinator)
